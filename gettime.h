// -*- C++ -*-
#ifndef CILK_UTIL_GETTIME_H_INCLUDED
#define CILK_UTIL_GETTIME_H_INCLUDED
 ...
 * counter to zero the first time util_gettime is called.
 *
...
extern "C++"
inline
unsigned int util_random(unsigned int n)
{
...
#endif // CILK_UTIL_GETTIME_H_INCLUDED
